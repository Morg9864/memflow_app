...
void main() {
  ...
  Flashcard buildCard({
    ...
    return Flashcard(
      ...
      allowedTestModes: const [TestMode.multipleChoice, TestMode.classicFlashcard],
      lastTestMode: null,
  ...
  test('again resets repetitions and schedules card in 10 minutes', () {
    ...
    expect(update.dueAt, baseNow.add(const Duration(minutes: 10)));
  });
  ...
  test('easy promotes mastery when repetitions and ease factor are high enough', () {
    final update = service.applyReview(
